...
module.exports = "<mat-sidenav-container class=\"all-wrap\" fullscreen>\n  <mat-sidenav #sidenav>\n    <mat-list>\n      <mat-list-item [routerLink]=\"['/']\"> Foo</mat-list-item>\n      <mat-list-item [routerLink]=\"['/bar']\"> Bar</mat-list-item>\n    </mat-list>\n  </mat-sidenav>\n\n  <div class=\"page-wrap\">\n    <header role=\"banner\">\n      <mat-toolbar color=\"primary\">\n        <button\n          type=\"button\"\n          mat-icon-button\n          (click)=\"sidenav.open()\"\n          title=\"Open sidenav\">\n          <mat-icon>menu</mat-icon>\n        </button>\n        Your Toolbar\n      </mat-toolbar>\n    </header>\n    <main class=\"content\">\n      <mat-card>\n        <mat-card-title> User Registration Form</mat-card-title>\n        <mat-card-content>\n\n          <form [formGroup]=\"userform\" (submit)=\"createuser()\">\n            <mat-form-field style=\"width: 100%;\">\n              <input matInput placeholder=\"UserName\" formControlName=\"userName\">\n            </mat-form-field>\n\n            <mat-form-field style=\"width: 100%\">\n              <input matInput placeholder=\"password\" formControlName=\"password\">\n            </mat-form-field>\n\n            <button mat-raised-button=\"accent\" style=\"float: right;clear: both\" type=\"submit\">submit</button>\n          </form>\n\n        </mat-card-content><br/><hr/>\n        <mat-card-footer>\n          <div style=\"text-align: center\">\n            <strong>  Iskcon IYF Ghaziabad </strong>\n            <hr/>\n          </div>\n        </mat-card-footer>\n\n      </mat-card>\n      <router-outlet></router-outlet>\n    </main>\n    <footer>\n      Your sticky footer with a variable height.\n    </footer>\n  </div>\n</mat-sidenav-container>\n\n<div class=\"example-container\">\n\n  <router-outlet></router-outlet>\n</div>\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n<!--&lt;!&ndash;<my-nav></my-nav>&ndash;&gt;-->\n\n<!--&lt;!&ndash;<dashboard></dashboard>&ndash;&gt;-->\n\n\n<!--&lt;!&ndash;{{tmsg}}&ndash;&gt;-->\n\n<!--&lt;!&ndash;<div [(hidden)]=\"!isTyping\" class=\"typing\"></div>&ndash;&gt;-->\n<!--&lt;!&ndash;<div class=\"chat\">&ndash;&gt;-->\n\n<!--&lt;!&ndash;</div>&ndash;&gt;-->\n <!--&lt;!&ndash;Muskan  :&ndash;&gt;-->\n<!--&lt;!&ndash;<input id=\"input\" type=\"text\" [(ngModel)]=\"message\" (keyup)=\"startTyping('muskan')\">&ndash;&gt;-->\n<!--&lt;!&ndash;<hr/>&ndash;&gt;-->\n<!--&lt;!&ndash;Sahil  :&ndash;&gt;-->\n<!--&lt;!&ndash;<input id=\"input1\" type=\"text\" [(ngModel)]=\"message\" (keyup)=\"startTyping('sahil')\">&ndash;&gt;-->\n\n\n<!--&lt;!&ndash;<button (click)=\"sendMessage()\">Send Message To Muskan</button>&ndash;&gt;-->\n\n<!--&lt;!&ndash;<hr/>&ndash;&gt;-->\n\n<!--&lt;!&ndash;<button (click)=\"sendMess()\">Send Message To Sahil</button>&ndash;&gt;-->\n"
...
var AppComponent = /** @class */ (function () {
    function AppComponent(formBuilder, usersignupservice) {
    ...
    AppComponent.prototype.createuser = function () {
        ...
        this.usersignupservice.saveNewUser(this.userform.value).subscribe(function (user) {
            return _this.usr = user;
        });
    };
    AppComponent.prototype.initializeWebSocketConnection = function () {
        var ws = new sockjs_client__WEBPACK_IMPORTED_MODULE_2__('http://localhost:8828/socket');
        this.stompClient = stompjs__WEBPACK_IMPORTED_MODULE_1__["over"](ws);
        var that = this;
        this.stompClient.connect({}, function (frame) {
            var _this = this;
            that.stompClient.subscribe('/chat/muskan', function (message) {
                if (message.body) {
                    jquery__WEBPACK_IMPORTED_MODULE_3__('.chat').append('<div class=\'message\'>' + message.body + '</div>');
                    console.log(message.body);
                }
            });
            that.stompClient.subscribe('/chat/sahil', function (message) {
                if (message.body) {
                    jquery__WEBPACK_IMPORTED_MODULE_3__('.chat').append('<div class=\'message\'>' + message.body + '</div>');
                    console.log(message.body);
                }
            });
            that.stompClient.subscribe('/chat/typing/sahil/muskan', function (message) {
                // alert("radhe radhe");
                if (message.body) {
                    _this.tmsg = message.body;
                    jquery__WEBPACK_IMPORTED_MODULE_3__('.typing').html('');
                    jquery__WEBPACK_IMPORTED_MODULE_3__('.typing').html('<div class=\'message\'>' + message.body + '</div>');
                    console.log(message.body + '---------');
                }
            });
            that.stompClient.subscribe('/chat/typing/sahil/sahil', function (message) {
                // alert("radhe radhe");
                if (message.body) {
                    _this.tmsg = message.body;
                    jquery__WEBPACK_IMPORTED_MODULE_3__('.typing').html('');
            ...
            that.stompClient.subscribe('/chat/typing/sahil', function (message) {
                if (message.body) {
                    var parsed = JSON.parse(message.body);
                    _this.tmsg = parsed.username + '  is typing';
    ...
    AppComponent.prototype.stopTyping = function (user) {
        this.isTyping = false;
    ...
    AppComponent.prototype.startTyping = function (user) {
        var _this = this;
        this.isTyping = true;
        console.log('typing ' + user);
        this.stompClient.send('/app/typing/sahil/' + user, {}, null);
        if (this.timer == undefined) {
            this.timer = rxjs_Rx__WEBPACK_IMPORTED_MODULE_4__["Observable"].interval(1200).subscribe(function (x) {
                _this.stopTyping(user);
            });
        }
    };
    AppComponent.prototype.sendMess = function () {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_3__('#input').val('');
    };
...
/* harmony import */ var _stomp_ng2_stompjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @stomp/ng2-stompjs */ "./node_modules/@stomp/ng2-stompjs/@stomp/ng2-stompjs.es5.js");
/* harmony import */ var _components_userregistraion_userregistraion_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/userregistraion/userregistraion.component */ "./src/app/components/userregistraion/userregistraion.component.ts");
...
var appRoutes = [
    { path: 'user-registration', component: _components_userregistraion_userregistraion_component__WEBPACK_IMPORTED_MODULE_6__["UserregistraionComponent"] },
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_10__["NgModule"])({
            declarations: [
                ...
                _components_userregistraion_userregistraion_component__WEBPACK_IMPORTED_MODULE_6__["UserregistraionComponent"],
            ...
            providers: [_my_nav_my_nav_component__WEBPACK_IMPORTED_MODULE_12__["MyNavComponent"], _services_data_service__WEBPACK_IMPORTED_MODULE_4__["DataService"],
                _stomp_ng2_stompjs__WEBPACK_IMPORTED_MODULE_5__["StompService"],
                {
                    provide: _stomp_ng2_stompjs__WEBPACK_IMPORTED_MODULE_5__["StompConfig"],
                    useValue: _stomp_ng2_stompjs__WEBPACK_IMPORTED_MODULE_5__["StompConfig"]
                }],
...
var UserComponent = /** @class */ (function () {
    ...
    UserComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.name = false;
        this.dataservice.getUsers().subscribe(function (employee) { return _this.empl = employee; });
    };
...
/***/ "./src/app/components/userregistraion/userregistraion.component.css":
/*!**************************************************************************!*\
  !*** ./src/app/components/userregistraion/userregistraion.component.css ***!
  \**************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/components/userregistraion/userregistraion.component.html":
/*!***************************************************************************!*\
  !*** ./src/app/components/userregistraion/userregistraion.component.html ***!
  \***************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/components/userregistraion/userregistraion.component.ts":
/*!*************************************************************************!*\
  !*** ./src/app/components/userregistraion/userregistraion.component.ts ***!
  \*************************************************************************/
/*! exports provided: UserregistraionComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UserregistraionComponent", function() { return UserregistraionComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var UserregistraionComponent = /** @class */ (function () {
    function UserregistraionComponent(breakpointObserver, formBuilder, http, service) {
    ...
    UserregistraionComponent.prototype.ngOnInit = function () {
        this.userform = this.formBuilder.group({
            userName: [],
            description: [],
            roundschant: [],
    ...
    UserregistraionComponent.prototype.save = function () {
        console.log(this.userform.value);
        this.service.getUserDetail(this.userform.value).subscribe();
    };
    UserregistraionComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-userregistraion',
            template: __webpack_require__(/*! ./userregistraion.component.html */ "./src/app/components/userregistraion/userregistraion.component.html"),
            styles: [__webpack_require__(/*! ./userregistraion.component.css */ "./src/app/components/userregistraion/userregistraion.component.css")]
        }),
    ...
    return UserregistraionComponent;
}());
...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.getUsers = function () {
        return this.http.get(this.apiUrl + '/getdetail');
    };
    DataService.prototype.getUserDetail = function (data) {
        // return this.http.get<Employee[]>('http://localhost:8080/getdetail');
        return this.http.put(this.apiUrl + '/adduser', data);
    };
    DataService.prototype.saveNewUser = function (data) {
        return this.http.put(this.apiUrl + '/account/register', data);
    };
...
module.exports = __webpack_require__(/*! /home/sahil/iconnect/src/main.ts */"./src/main.ts");
